...
class SpringdatajpaApplicationTests {
	...
	void saveProduct() {
		...
		System.out.println(productsRepo.findByName("Mi phone"));
		
		System.out.println(productsRepo.findByPrice(500d));
		
		System.out.println(productsRepo.findByNameAndPrice("Mi phone", 500d));
